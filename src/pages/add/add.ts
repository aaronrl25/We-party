...
export class AddPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public dataProvider: DataProvider, public angularfireDatabase: AngularFireDatabase,
    public loadingProvider: LoadingProvider, public alertCtrl: AlertController, public imageProvider: ImageProvider, public modalCtrl: ModalController, public camera: Camera, public keyboard: Keyboard) { }
  ...
  setMessagesRead(messages) {
    if (this.navCtrl.getActive().instance instanceof AddPage) {
  ...
  editmsg(message) {
    ...
    this.alert = this.alertCtrl.create({
      ...
      message: "Please enter a new Messafe.",
      inputs: [
        {
          name: 'description',
