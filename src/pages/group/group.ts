...
export class GroupPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public dataProvider: DataProvider,
    public modalCtrl: ModalController, public angularfireDatabase: AngularFireDatabase, public alertCtrl: AlertController,
  ...
  setMessagesRead(messages) {
    if (this.navCtrl.getActive().instance instanceof GroupPage) {
      ...
      this.angularfireDatabase.object('/accounts/' + firebase.auth().currentUser.uid + '/groups/' + this.groupId).update({
