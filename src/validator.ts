...
export namespace Validator {
  ...
  export const groupDateValidator = ['', [Validators.required, Validators.minLength(1)]];
  export const groupHoraValidator = ['', [Validators.required, Validators.minLength(1)]];

  export const grouptUbicacionValidator = ['', [Validators.required, Validators.minLength(1)]];
  export const groupTelValidator = ['', [Validators.required, Validators.minLength(1)]];
